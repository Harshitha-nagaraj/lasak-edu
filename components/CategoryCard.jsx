  ...
  return (
    ...
    >
      <div
        ...
        className="relative h-40 rounded-[22px] bg-gradient-to-br from-[#0b1020] to-[#0f172a] text-white overflow-hidden cursor-pointer flex items-center justify-center group
