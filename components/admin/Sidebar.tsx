...
import { LayoutDashboard, FileText, Image, Users, Award, Briefcase, MessageSquare, Settings, LogOut, Shield, Youtube, Menu, X, BookOpen, Layers, Phone, Info, Video, HelpCircle, FileCheck, Globe, PenTool, GraduationCap, Newspaper, Tag } from 'lucide-react';
...
const Sidebar = () => {
    ...
    const navigation = menuItems.filter(item => !item.adminOnly || isAdmin);
    ...
    return (
        <>
            ...
            <motion.div
                ...
                className={`fixed md:static inset-y-0 left-0 bg-white border-r border-gray-200 z-40 overflow-hidden flex flex-col h-screen shadow-xl md:shadow-none transition-all duration-300 ${!isOpen && 'hidden md:flex md:w-0'}`}
            >
                {/* Logo Area */}
