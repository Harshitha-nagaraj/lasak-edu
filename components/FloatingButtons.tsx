      ...
      <div className="fixed bottom-4 right-4 sm:bottom-5 sm:right-5 md:bottom-6 md:right-6 flex flex-col gap-3 sm:gap-4 z-50">
        ...
        <div className="relative group">
            ...
            {showGreeting && !isChatOpen && (
              <div className="absolute bottom-full right-0 mb-4 w-64 bg-white rounded-2xl shadow-2xl p-4 border border-slate-100 z-[60]">
          ...
          <button aria-label="Chat with AI support" onClick={() => { setIsChatOpen(true); setShowGreeting(false); }} title="Chat with Sakthi" className="w-11 h-11 sm:w-12 sm:h-12 md:w-14 md:h-14 bg-white rounded-full flex items-center justify-center shadow-lg border border-slate-200">
            <img 
              src={chatIcon} 
