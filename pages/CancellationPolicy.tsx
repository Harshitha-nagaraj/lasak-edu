      ...
      <header className="bg-white border-b border-slate-200 py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-black text-slate-900 mb-6">Cancellation Policy</h1>
      ...
      <main className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100">
            ...
            <div className="bg-slate-50 border-2 border-slate-200 rounded-3xl p-6 md:p-8 mb-12 flex items-start gap-6 relative overflow-hidden group">
              <div className="absolute top-0 right-0 w-32 h-32 bg-slate-100 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 opacity-50 group-hover:bg-slate-200 transition-colors"></div>
              <div className="w-14 h-14 bg-slate-800 rounded-2xl flex items-center justify-center shrink-0 shadow-lg shadow-slate-200">
                <AlertTriangle className="text-white w-8 h-8" />
              </div>
              <div className="relative z-10">
                <h2 className="text-2xl font-black text-slate-900 mb-2 uppercase tracking-tight italic">Important Notice</h2>
                <p className="text-slate-700 font-bold leading-relaxed">
                  Cancellation of enrollment <strong>DOES NOT</strong> entitle the student to any refund of fees paid. Please read the terms below carefully.
                </p>
              </div>
            </div>
