  ...
  useEffect(() => {
    const fetchContent = async () => {
      try {
        ...
        const docRef = doc(db, 'site_settings', 'terms_conditions_content');
      ...
      <header className="bg-white border-b border-slate-200 py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-black text-slate-900 mb-6">Terms & Conditions</h1>
          ...
          <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-[2.5rem] p-8 md:p-12 text-white overflow-hidden relative group">
            ...
            <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-slate-600 font-medium">If you have any questions regarding these Terms & Conditions, please reach out to our legal team.</p>
              </div>
